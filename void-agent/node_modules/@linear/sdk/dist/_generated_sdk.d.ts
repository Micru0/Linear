 ...
 */
export declare class AgentActivityObservationContent extends Request {
    constructor(request: LinearRequest, data: L.AgentActivityObservationContentFragment);
 ...
 */
export declare class AgentActivityUserInputContent extends Request {
    constructor(request: LinearRequest, data: L.AgentActivityUserInputContentFragment);
    /** The user input body. */
    body?: string;
...
export declare class AgentContext extends Request {
    ...
    status: L.AgentContextStatus;
    /** The type of the agent context. */
    type: L.AgentContextType;
 ...
 */
export declare class AgentContextEventWebhookPayload {
    constructor(data: L.AgentContextEventWebhookPayloadFragment);
...
export declare class User extends Request {
    ...
    supervisedIssues(variables?: Omit<L.User_SupervisedIssuesQueryVariables, "id">): LinearFetch<IssueConnection>;
 ...
 */
export declare class User_SupervisedIssuesQuery extends Request {
    private _id;
    private _variables?;
    constructor(request: LinearRequest, id: string, variables?: Omit<L.User_SupervisedIssuesQueryVariables, "id">);
    /**
     ...
     */
    fetch(variables?: Omit<L.User_SupervisedIssuesQueryVariables, "id">): LinearFetch<IssueConnection>;
}
/**
 ...
 */
export declare class Viewer_SupervisedIssuesQuery extends Request {
    private _variables?;
    constructor(request: LinearRequest, variables?: L.Viewer_SupervisedIssuesQueryVariables);
    /**
     ...
     */
    fetch(variables?: L.Viewer_SupervisedIssuesQueryVariables): LinearFetch<IssueConnection>;
}
/**
